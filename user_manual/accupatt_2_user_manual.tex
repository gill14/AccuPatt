...
\begin{document}
    ...
    \end{itemize}
    The \textbf{Card Analysis} tab also contains \textbf{Series Options} which can apply to all passes and/or the average pattern:
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{average-center-method:} text, option=[none, centroid, center-of-distribution]
