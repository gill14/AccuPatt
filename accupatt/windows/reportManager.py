...
Ui_Form, baseclass = uic.loadUiType(os.path.join(os.getcwd(), 'resources', 'editReports.ui'))
...
class ReportManager(baseclass):
    ...
    def __init__(self, parent=None):
        ...
        parms = [
            {'name': 'Header Page', 'type': 'group', 'children': [
                {'name': 'Fly-In', 'type': 'bool', 'value': True}
            ]},
            {'name': 'String', 'type': 'group', 'children': [
                {'name': 'String Page', 'type': 'bool', 'value': True}
            ]}
        ]
