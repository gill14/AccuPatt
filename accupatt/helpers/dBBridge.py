...
def _load_table_spray_cards(c: sqlite3.Cursor, p: Pass, file: str):
    #Spray Cards Table
    c.execute('''SELECT id, name, location, location_units, include_in_composite, threshold_type, threshold_method_grayscale, threshold_grayscale, threshold_color_hue_min, threshold_color_hue_max, threshold_color_hue_pass, threshold_color_saturation_min, threshold_color_saturation_max, threshold_color_saturation_pass, threshold_color_brightness_min, threshold_color_brightness_max, threshold_color_brightness_pass, watershed, min_stain_area_px, stain_approximation_method, dpi, spread_method, spread_factor_a, spread_factor_b, spread_factor_c, has_image FROM spray_cards WHERE pass_id = ?''',(p.id,))
    cards = c.fetchall()
    for row in cards:
        sc = SprayCard(id=row[0], name=row[1], filepath=str(file))
        _, _, sc.location, sc.location_units, sc.include_in_composite, sc.threshold_type, sc.threshold_method_grayscale, sc.threshold_grayscale, hmin, hmax, hpass, smin, smax, spass, bmin, bmax, bpass, sc.watershed, sc.min_stain_area_px, sc.stain_approximation_method, sc.dpi, sc.spread_method, sc.spread_factor_a, sc.spread_factor_b, sc.spread_factor_c, sc.has_image = row
...
def _update_table_spray_cards(c: sqlite3.Cursor, p: Pass):
    ...
    for card in p.spray_cards:
        c.execute('''INSERT INTO spray_cards (id, pass_id, name, location, location_units, include_in_composite, threshold_type, threshold_method_grayscale, threshold_grayscale, threshold_color_hue_min, threshold_color_hue_max, threshold_color_hue_pass, threshold_color_saturation_min, threshold_color_saturation_max, threshold_color_saturation_pass, threshold_color_brightness_min, threshold_color_brightness_max, threshold_color_brightness_pass, watershed, min_stain_area_px, stain_approximation_method, dpi, spread_method, spread_factor_a, spread_factor_b, spread_factor_c, has_image) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                        ...
                        (card.id, p.id, card.name, card.location, card.location_units, card.include_in_composite, card.threshold_type, card.threshold_method_grayscale, card.threshold_grayscale, card.threshold_color_hue_min, card.threshold_color_hue_max, card.threshold_color_hue_pass, card.threshold_color_saturation_min, card.threshold_color_saturation_max, card.threshold_color_saturation_pass, card.threshold_color_brightness_min, card.threshold_color_brightness_max, card.threshold_color_brightness_pass, card.watershed, card.min_stain_area_px, card.stain_approximation_method, card.dpi, card.spread_method, card.spread_factor_a, card.spread_factor_b, card.spread_factor_c, card.has_image))
