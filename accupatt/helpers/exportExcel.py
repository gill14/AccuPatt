        ...
        if p.has_card_data():
            ...
            for k, c in enumerate(p.spray_cards):
                ...
                vals = [
                    ...
                    c.threshold_method_color,
                    c.threshold_color_hue[0],
                    c.threshold_color_hue[1],
                    c.threshold_color_saturation[0],
                    c.threshold_color_saturation[1],
                    c.threshold_color_brightness[0],
                    c.threshold_color_brightness[1],
                    c.dpi,
                    c.spread_method,
                    c.spread_factor_a,
                    c.spread_factor_b,
